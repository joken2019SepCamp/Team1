    ...
    <div id="main"　class="col-md-8 sticky">
       <p>
            ...
            try{
              ...
              $sql="SELECT COUNT(*) FROM kakomon where name='".$kyoka."' and old='".$old."' and zengo='".$zengo."'and cyuki='".$chuki."'";
              ...
              if($pika['COUNT(*)']>=1){
                  echo 'ある：';
                  $sql="SELECT * from kakomon where name='".$kyoka."' and old='".$old."' and zengo='".$zengo."'and cyuki='".$chuki."'";
                  $stmt = $dbh->prepare($sql);
                  $stmt->execute();
                  $data=array();
                  $count=$stmt->rowCount();
